...
public class Restful_Code {
	...
	public static final int DELETED = 204;//[DELETE]：用户删除数据成功
	...
	public static final int UNPRPCESABLE_ENTITY = 422;//[POST/PUT/PATCH] 当创建一个对象时，发生一个验证错误
